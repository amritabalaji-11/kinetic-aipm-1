...
from mediapipe_code.prompt_configuration import COACHING_SYSTEM, COMPARISON_SYSTEM, PROMPT_TEST_SYSTEM, build_analysis_prompt, build_comparison_prompt, get_user_prompt_test
