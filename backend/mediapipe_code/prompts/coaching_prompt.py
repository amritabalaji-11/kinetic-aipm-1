...
WEIGHT RECOMMENDATIONS — CRITICAL RULE:
  If form deteriorates in later reps (RC4 — load deficit):
    ...
    - User does not need weight suggestions from Haiku Call 1
    - User will see weight recommendations from Haiku Call 2 (progression comparison)
    - For RC4: focus next_session_focus on FORM QUALITY and controlled tempo
    EXAMPLE RC4 next_session_focus:
