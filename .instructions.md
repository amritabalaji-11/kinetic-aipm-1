...
| **Ankle dorsiflexion** (shin from vert.) | 22–35° | 17–21° | 13–16° | 8–12° | 0–7° |
...
```json
{
  ...
  "ankle_dorsiflexion":         { "excellent": [22, 35],  "good": [17, 21],  "unit": "degrees" },
...
| **Ankle dorsiflexion** (shin from vert.) | 25–35° | 20–24° | 10–19° | 0–9° | <0° / heel lifting |
| **Descent tempo** (eccentric seconds) | 1.8–2.8 s | 1.4–1.79 s | 1.0–1.39 s | 0.6–0.99 s | <0.6 s |
| **Ascent tempo** (concentric seconds) | 1.0–2.0 s | 0.7–0.99 s | 0.5–0.69 s | 0.3–0.49 s | <0.3 s |
| **Pause at bottom** | 0.5–1.5 s | 0.3–0.49 s | <0.3 s | — | — |
...
```json
{
  ...
  "ankle_dorsiflexion":         { "excellent": [25, 35],  "good": [20, 24],  "unit": "degrees" },
  "descent_tempo_s":            { "excellent": [1.8, 2.8], "good": [1.4, 1.79] },
  "ascent_tempo_s":             { "excellent": [1.0, 2.0], "good": [0.7, 0.99] }
}
```
...
| Ankle dorsiflexion | ✅ readable | ⚠️ less reliable | ✅ most reliable |
...
**Signature:**
- Shin angle < 20° at bottom (front camera) or < 20° (side camera)
...
**Severity thresholds:**
- Mild: 15–19° shin angle from vertical
- Moderate: 10–14°
- Severe: <10° or visible heel lift
